...
HiLink coqVernacPunctuation  @keyword.proof
HiLink coqTermPunctuation    @keyword.proof

HiLink coqGoalLine           @keyword.proof
HiLink coqGoalSep            @keyword.proof

HiLink coqHypothesisBody     @tactic
HiLink coqGoalBlock          @tactic

HiLink coqKwd                @keyword.vernacular
